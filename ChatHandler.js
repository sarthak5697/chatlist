...
const chat_names = ["Name_1", "Name_2", "Name_3", "Name_4", "Name_5", "Name_6", ""];
const chat_names_length = chat_names.length;
const chat_msg = ["Hii how are you ! what are you doing nowadays ?",
    "i am really good how are you ? and  3 here looks great!...",
    "Thanks 2 for the compliment ",
    "its been so long since we all got together ..",
    "yes he is right it has been so long ",
    "no matter we all are here now lets enjoy to the fullest"
